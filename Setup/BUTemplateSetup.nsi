...
;General
	...
	;Name and file
	!define PROGRAM_NAME "BilderUploader" ;Name
	!define PROGRAM_VERSION "TemplateY" ;Version
	!define PROGRAM_STARTMENU_DIR "BilderUploader"
	!define PROGRAM_SHORTCUT_NAME "BilderUploader"
	!define PROGRAM_EXECUTABLE "BilderUploader.jar"
	!define PROGRAM_ICON "BUIcon.ico"
...
Section !$(SecMainName) SecMain
	...
	;Install files
	SetOverwrite on
	File "..\BilderUploader.jar"
	File "..\LICENSE"
	File "..\BUIcons\Icon\BUIcon.ico"
...
Section "Uninstall"
	...
	Delete "$INSTDIR\BUIcon.ico"
	Delete "$INSTDIR\directories.properties.example"
	Delete "$INSTDIR\lib\*.jar"
	Delete "$INSTDIR\Uninstall.exe"
	
	MessageBox MB_YESNO "Remove also all Hosts and Templates?" IDYES true IDNO false
	true:
