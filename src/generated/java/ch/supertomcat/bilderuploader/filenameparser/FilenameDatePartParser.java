...
/**
 * <p>Java class for FilenameDatePartParser complex type</p>.
 * 
...
public class FilenameDatePartParser {
     ...
     * This is why there is not a <CODE>set</CODE> method for the dateParser property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the dateParser property.
     */
    public List<DateParser> getDateParser() {
        if (dateParser == null) {
            dateParser = new ArrayList<>();
        }
